...
public class ContentBlockerTargetManager {
    ...
    private init() {
        targets = [
            ...
            // iOS Targets
            ContentBlockerTargetInfo(primaryCategory: .ads, platform: .iOS, bundleIdentifier: "syferlab.wBlock.wBlock-Ads-iOS", rulesFilename: "rules_ads_ios.json"),
            ContentBlockerTargetInfo(primaryCategory: .privacy, platform: .iOS, bundleIdentifier: "syferlab.wBlock.wBlock-Privacy-iOS", rulesFilename: "rules_privacy_ios.json"),
            ContentBlockerTargetInfo(primaryCategory: .security, platform: .iOS, bundleIdentifier: "syferlab.wBlock.wBlock-Security-iOS", rulesFilename: "rules_security_ios.json"),
            ContentBlockerTargetInfo(primaryCategory: .annoyances, platform: .iOS, bundleIdentifier: "syferlab.wBlock.wBlock-Annoyances-iOS", rulesFilename: "rules_annoyances_ios.json"),
            ContentBlockerTargetInfo(primaryCategory: .multipurpose, platform: .iOS, bundleIdentifier: "syferlab.wBlock.wBlock-Multipurpose-iOS", rulesFilename: "rules_multipurpose_ios.json"),
            ContentBlockerTargetInfo(primaryCategory: .foreign, platform: .iOS, bundleIdentifier: "syferlab.wBlock.wBlock-Foreign-iOS", rulesFilename: "rules_foreign_ios.json"),
            ContentBlockerTargetInfo(primaryCategory: .experimental, platform: .iOS, bundleIdentifier: "syferlab.wBlock.wBlock-Experimental-iOS", rulesFilename: "rules_experimental_ios.json"),
            ContentBlockerTargetInfo(primaryCategory: .custom, platform: .iOS, bundleIdentifier: "syferlab.wBlock.wBlock-Custom-iOS", rulesFilename: "rules_custom_ios.json")
        ]
    }
